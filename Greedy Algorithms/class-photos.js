...
function classPhotos(redShirtHeights, blueShirtHeights) {
    ...
    if (blueShirtHeights[blueShirtHeights.length - 1] > redShirtHeights[redShirtHeights.length - 1]) {
        for (let i = blueShirtHeights.length - 1; i>=0; i--) {
            if (blueShirtHeights[i]<=redShirtHeights[i]) {
                return false
            }
        }
    } else if (blueShirtHeights[blueShirtHeights.length - 1] < redShirtHeights[redShirtHeights.length - 1]) {
        for (let i = blueShirtHeights.length - 1; i>=0; i--) {
            if (blueShirtHeights[i]>=redShirtHeights[i]) {
                return false
            }
